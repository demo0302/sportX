...
const Sidebar = () => {
	...
	return (
		...
		`}
			...
			<button
				className='lg:hidden fixed top-4 left-4 p-2 bg-purple-500 text-white rounded-md z-0'
				onClick={toggleSidebar}
			>
...
const NoMatchesFound = () => (
	<div className='flex flex-col items-center justify-center h-full text-center'>
		...
		<p className='text-gray-500 max-w-xs'>
			Don&apos;t worry! Your perfect match is just around the corner. Keep Matching!
		</p>
	</div>
);
