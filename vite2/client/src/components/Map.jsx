...
export default function Map() {
  ...
  }, [nearbyMarkers]); // Runs only when nearby markers update

  useEffect(() => {
    if (!mapRef.current) return;

    setUserPosition(location); // Update user position only when location changes
  ...
  }, [location]); // Depend only on location updates
